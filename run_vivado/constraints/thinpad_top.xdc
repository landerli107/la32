...
########################################################################
# Asynchronous SRAM interface timing
########################################################################
set SRAM_OUT_PORTS [get_ports {base_ram_addr[*] base_ram_be_n[*] \
                               base_ram_ce_n base_ram_oe_n base_ram_we_n \
                               ext_ram_addr[*] ext_ram_be_n[*] \
                               ext_ram_ce_n ext_ram_oe_n ext_ram_we_n}]
set SRAM_DQ_PORTS  [get_ports {base_ram_data[*] ext_ram_data[*]}]

set_property SLEW FAST $SRAM_OUT_PORTS
set_property SLEW FAST $SRAM_DQ_PORTS
set_property DRIVE 16  $SRAM_OUT_PORTS
set_property DRIVE 16  $SRAM_DQ_PORTS

# Constrain previously-unconstrained board I/O paths; this does not relax
# the internal clk_raw setup/hold requirement.
set_max_delay 9.000 -to   $SRAM_OUT_PORTS
set_max_delay 9.000 -to   $SRAM_DQ_PORTS
set_max_delay 5.500 -from $SRAM_DQ_PORTS
